...
import { useLoginForm } from '@/core/hooks/auth'
...
export const LoginForm = () => {
    ...
    return (
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
            ...
            <CustomButton
                type="submit"
                disabled={loading || isSigningInWithGoogle}
            >
            ...
            <motion.button
                ...
                disabled={loading || isSigningInWithGoogle}
                className="w-full flex justify-center items-center px-4 py-3 border border-gray-600 rounded-md shadow-sm bg-white text-gray-900 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
